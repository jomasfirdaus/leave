...
urlpatterns = [
	...
	path('accept/leave/request/<str:id>/', views.aceptedleaverequest, name='aceptedleaverequest'),
	path('reject/leave/request/<str:id>/', views.rijectedleaverequest, name='rijectedleaverequest'),
]
